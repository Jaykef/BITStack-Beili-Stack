...
def signup(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.success(request, f"Thanks for Signing Up {username}, please click on the link we sent to your email to activate your account.")
            return redirect("/")
        else:
...
def editprofile(request):
    ...
    if request.method == 'POST':
        ...
        if request.FILES and request.FILES['coverInput']:
            user.cover_pic = request.FILES['coverInput']
