...
class StackoverflowUser(AbstractUser):
    ...
    about_me = models.TextField(default='Write something about you here.')
    ques_asked = models.ManyToManyField('main.Questions', blank = True)
    post_posted = models.ManyToManyField('main.Posts', blank = True)
    ...
    cover_pic = models.ImageField(upload_to='user_profile_pic', default='cover.jpg',blank=True, null = True)
